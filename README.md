...
4. When the download ends, open the file.
...
6. If a setup window appears, follow the prompts.
7. If the app opens in a folder, keep the files together and run the main file again when needed.
...
3. Use the built-in options shown on screen.
4. Close the app when you are done.
5. Reopen it from the same file or shortcut later.
